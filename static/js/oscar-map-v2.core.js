...
function init() {
    ...
    if (localStorage.getItem("h-route") == "true") {
        $("#h-route").prop("checked", true);
    }
    if (localStorage.getItem("l-route") == "true") {
        $("#l-route").prop("checked", true);
    }
    if (localStorage.getItem("atc-s") == "true") {
        $("#atc-s").prop("checked", true);
    }
...
function checkShowHRoute() {
    let obj = $("#h-route");
    if (obj.prop("checked")) {
        localStorage.setItem("h-route", "true");
        return true;
    } else {
        localStorage.setItem("h-route", "false");
        return false;
    }
}
function checkShowLRoute() {
    let obj = $("#l-route");
    if (obj.prop("checked")) {
        localStorage.setItem("l-route", "true");
        return true;
    } else {
        localStorage.setItem("l-route", "false");
        return false;
    }
}

function checkShowAtcS() {
    let obj = $("#atc-s");
    if (obj.prop("checked")) {
        localStorage.setItem("atc-s", "true");
        return true;
    } else {
        localStorage.setItem("atc-s", "false");
        return false;
    }
}
...
function updMap() {
    ...
    L.tileLayer("https://tiles.flightradar24.com/navdata_ha/{z}/{x}/{y}/tile.png", {
        attribution: '<a href="https://www.flightradar24.com/">Flightradar24</a>',
    }).addTo(map);
    ...
    if (localStorage.getItem("l-route") == "true") {
          ...
          L.tileLayer("https://tiles.flightradar24.com/navdata_la/{z}/{x}/{y}/tile.png", {
        attribution: '<a href="https://www.flightradar24.com/">Flightradar24</a>',
    }).addTo(map);
    }
    if (localStorage.getItem("atc-s") == "true") {
         L.tileLayer("https://tiles.flightradar24.com/atc_boundaries/{z}/{x}/{y}/tile.png", {
        attribution: '<a href="https://www.flightradar24.com/">Flightradar24</a>',
    }).addTo(map);
